...
class detail_AK extends StatefulWidget {
  final String id;
  const detail_AK({super.key, required this.id});

  @override
  State<detail_AK> createState() => _Detail_AKState();
}

class _Detail_AKState extends State<detail_AK> {
  late int quantity;

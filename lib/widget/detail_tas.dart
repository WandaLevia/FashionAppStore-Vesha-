...
class detail_T extends StatefulWidget {
  final String id;
  const detail_T({super.key, required this.id});

  @override
  State<detail_T> createState() => _Detail_TState();
}

class _Detail_TState extends State<detail_T> {
  late int quantity;

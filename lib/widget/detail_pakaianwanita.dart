...
class detail_PW extends StatefulWidget {
  final String id;
  const detail_PW({super.key, required this.id});

  @override
  State<detail_PW> createState() => _Detail_PWState();
}

class _Detail_PWState extends State<detail_PW> {
  late int quantity;

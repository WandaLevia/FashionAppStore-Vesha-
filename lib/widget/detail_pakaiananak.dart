...
class detail_PA extends StatefulWidget {
  final String id;
  const detail_PA({super.key, required this.id});

  @override
  State<detail_PA> createState() => _Detail_PAState();
}

class _Detail_PAState extends State<detail_PA> {
  late int quantity;

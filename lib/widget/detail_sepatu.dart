...
class detail_S extends StatefulWidget {
  final String id;
  const detail_S({super.key, required this.id});

  @override
  State<detail_S> createState() => _Detail_PPState();
}

class _Detail_PPState extends State<detail_S> {
  late int quantity;

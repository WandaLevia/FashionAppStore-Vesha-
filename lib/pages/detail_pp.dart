...
import 'package:fashion_app/widget/detail_pakaianpria.dart';
import 'package:flutter/material.dart';

class DetailPP extends StatefulWidget {
  const DetailPP({super.key, required categories});
      ...
      body: Column(
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirestoreService().getpakaianpria(),
